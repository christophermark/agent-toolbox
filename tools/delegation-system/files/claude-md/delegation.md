...
- Prefer the named agents above over unnamed general-purpose spawns — those inherit this session's expensive model and (since Claude Code v2.1.219) can spawn their own subagents by default, fanning out cost you never see itemized.
